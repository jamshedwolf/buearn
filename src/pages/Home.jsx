...
function Home() {
    return (
        <div className="flex  flex-col  relative z-[10]  bg-[#020102] ">
            {/* Main container for the Home component */}
            <div className='flex gap-5 mt-[100px]  flex-col max-w-7xl mx-auto lg:flex-row min-h-screen  justify-center lg:items-start'>
                {/* Container for the m content area */}
                <div className="lg:basis-1/2 align-items-top lg:px-15 basis-1/3 lg:pl-[90px]  order-2 lg:order-1 p-5">
                    {/* Left section with welcome text and buttons */}
                    <div className="text-3xl lg:text-5xl font-bold text-white z-[10]  ">
                        WELCOME TO THE <span className=' text-center fontbox text-[#9f28ff]'>buEARN</span>
                    </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <button className='h-[50px]  hover:bg-[#9f28ff] fontbox hover:border-0  text-[10px] lg:text-[12px] flex gap-3 items-center text-white px-8 border border-white shadow-lg mt-5 rounded-lg'>
                ...
                <div className="lg:basis-1/2 basis-1/3 order-1 lg:order-2 text-center  text-white">
                    ...
                    <div className="w-[300px] font-ArialMT lg:w-[350px]  mx-auto rounded-[15px] z-[40] p-5 h-[500px] lg:h-[550px] bg-[#591d71]">
                        ...
                        <div className="">
                            ...
                            <button className='py-2 px-4 hover:shadow-[#9f28ff]  bg-[#9f28ff] shadow-lg mt-5 rounded-lg fontbox'>mint now</button>
                        </div>
                    </div>
                </div>
                <div className="absolute hidden z-[-1] lg:block top-0 left-0 w-[300px] rounded-full h-[400px] bg-[#9f28ff] blur-[150px]"></div>
                <div className="absolute hidden z-[-1] lg:block top-[-5] right-20 w-[500px] rounded-full h-[500px] bg-[#9f28ff] blur-[200px]"></div>
            </div>
