                ...
                {[...Array(8)].map((_, index) => (
                    <div key={index} className="text-white collapse mt-5 bg-[#020102] collapse-plus border shadow-lg border-2 border-[#152329]">
                        ...
                        <div className="collapse-title text-[10px] md:text-2xl font-medium">
                            <span className="text-[10px] md:text-2xl font-medium md:mx-10 mx-5">{`0${index + 1}`}</span>
                            Lorem ipsum dolor sit amet.
                        </div>
                        <div className="collapse-content text-white/80 text-[10px] md:text-xl lg:text-2xl md:ml-10">
